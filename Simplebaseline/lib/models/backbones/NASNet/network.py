...
class NASNetAMobile(nn.Module):
    ...
    def forward(self, input):
        ...
        x_cell_3 = self.cell_3(x_cell_2, x_cell_1)      # x8

        # print("x_cell_3: {}".format(x_cell_3.size()[1]))
        features.append(x_cell_3)   # 1/8
        x_reduction_cell_0 = self.reduction_cell_0(x_cell_3, x_cell_2)

        x_cell_6 = self.cell_6(x_reduction_cell_0, x_cell_3)
        x_cell_7 = self.cell_7(x_cell_6, x_reduction_cell_0)
        x_cell_8 = self.cell_8(x_cell_7, x_cell_6)
        x_cell_9 = self.cell_9(x_cell_8, x_cell_7)  # x16

        # print("x_cell_9: {}".format(x_cell_9.size()[1]))
        features.append(x_cell_9)   # 1/6
        x_reduction_cell_1 = self.reduction_cell_1(x_cell_9, x_cell_8)

        x_cell_12 = self.cell_12(x_reduction_cell_1, x_cell_9)
        x_cell_13 = self.cell_13(x_cell_12, x_reduction_cell_1)
        x_cell_14 = self.cell_14(x_cell_13, x_cell_12)
        x_cell_15 = self.cell_15(x_cell_14, x_cell_13)  # x32

        # print("x_cell_15: {}".format(x_cell_15.size()[1]))
        features.append(x_cell_15)  # 1/32
        return features
