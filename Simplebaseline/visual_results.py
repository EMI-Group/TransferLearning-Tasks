...
def parse_args():
    ...
    parser.add_argument('--model', help='which model is used as backbone', type=str, default='csonas')
    parser.add_argument('--image_path', help='Path of COCO val images', type=str, default='/raid/huangsh/datasets/MSCOCO2017/val2017/')
    parser.add_argument('--gt_anno', help='Path of COCO val annotation', type=str, default="/raid/huangsh/datasets/MSCOCO2017/annotations/person_keypoints_val2017.json")
    ...
    args.prediction = "/raid/huangsh/code/HumanPose_estimation/output/coco/pose_{}/coco_256x192_d256x3_adam_lr1e-3/results/keypoints_val2017_results.json".format(args.model)
    ...
    for catId in catIds:
        for imgId in p.imgIds[:5000]:
            ...
            if save:
                ...
                plt.savefig('id_' + str(imgId) + '_' + img_name + '.png', format='png', bbox_inckes='tight', dpi=100)
